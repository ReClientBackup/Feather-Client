...
public class WorldGenFlowers extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, BlockPos position)
    {
        for (int i = 0; i < 64; ++i)
        {
            ...
            if (world.isAirBlock(blockpos) && (!world.provider.getHasNoSky() || blockpos.getY() < 255) && this.flower.canBlockStay(world, blockpos, this.field_175915_b))
            {
                world.setBlockState(blockpos, this.field_175915_b, 2);
            }
        }
