...
public class MapGenVillage extends MapGenStructure
{
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World world, Random rand, int x, int z, int p_i2092_5_)
        {
            super(x, z);
            List<StructureVillagePieces.PieceWeight> list = StructureVillagePieces.getStructureVillageWeightedPieceList(rand, p_i2092_5_);
            StructureVillagePieces.Start structurevillagepieces$start = new StructureVillagePieces.Start(world.getWorldChunkManager(), 0, rand, (x << 4) + 2, (z << 4) + 2, list, p_i2092_5_);
