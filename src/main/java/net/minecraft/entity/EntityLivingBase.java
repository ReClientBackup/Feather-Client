...
public abstract class EntityLivingBase extends Entity {
    ...
    public int swingProgressInt, arrowHitTimer;
    ...
    protected float prevOnGroundSpeedFactor, onGroundSpeedFactor, movedDistance, prevMovedDistance,  field_70741_aB;
    ...
    protected double newPosY, newPosZ;
    ...
    public void addPotionEffect(PotionEffect effect) {
        if (this.isPotionApplicable(effect)) {
            if (this.activePotionsMap.containsKey(effect.getPotionID())) {
                this.activePotionsMap.get(effect.getPotionID()).combine(effect);
                this.onChangedPotionEffect(this.activePotionsMap.get(effect.getPotionID()), true);
            } else {
    ...
    public void knockBack(double x, double y) {
        if (this.rand.nextDouble() >= this.getEntityAttribute(SharedMonsterAttributes.knockbackResistance).getAttributeValue()) {
            ...
            float f = MathHelper.sqrt_double(x * x + y * y);
            float f1 = 0.4F;
            this.motionX /= 2.0D;
            this.motionY /= 2.0D;
            this.motionZ /= 2.0D;
            this.motionX -= x / (double)f * (double)f1;
            this.motionY += f1;
            this.motionZ -= y / (double)f * (double)f1;
    ...
    public void dismountEntity(Entity entity) {
        ...
        double d1 = entity.getEntityBoundingBox().minY + (double)entity.height;
    ...
    public void onItemPickup(Entity entity, int p_71001_2_)
    {
        if (!entity.isDead && !this.worldObj.isRemote) {
            ...
            if (entity instanceof EntityItem) {
                tracker.sendToAllTrackingEntity(entity, new S0DPacketCollectItem(entity.getEntityId(), this.getEntityId()));
            }
