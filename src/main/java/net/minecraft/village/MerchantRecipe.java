...
public class MerchantRecipe {
    ...
    public void readFromTags(NBTTagCompound tagCompound) {
        NBTTagCompound buy = tagCompound.getCompoundTag("buy");
        this.itemToBuy = ItemStack.loadItemStackFromNBT(buy);
        NBTTagCompound sell = tagCompound.getCompoundTag("sell");
        this.itemToSell = ItemStack.loadItemStackFromNBT(sell);
