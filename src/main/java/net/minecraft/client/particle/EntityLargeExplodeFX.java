...
public class EntityLargeExplodeFX extends EntityFX
{
    ...
    protected EntityLargeExplodeFX(TextureManager renderEngine, World world, double xCoordIn, double yCoordIn, double zCoordIn, double p_i1213_9_, double p_i1213_11_, double p_i1213_13_)
    {
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new EntityLargeExplodeFX(Minecraft.getMinecraft().getTextureManager(), world, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
        }
    }
}
