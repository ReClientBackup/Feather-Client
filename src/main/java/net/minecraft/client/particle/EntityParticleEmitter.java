...
public class EntityParticleEmitter extends EntityFX
{
    ...
    public EntityParticleEmitter(World world, Entity p_i46279_2_, EnumParticleTypes particleTypesIn)
    {
        super(world, p_i46279_2_.posX, p_i46279_2_.getEntityBoundingBox().minY + (double)(p_i46279_2_.height / 2.0F), p_i46279_2_.posZ, p_i46279_2_.motionX, p_i46279_2_.motionY, p_i46279_2_.motionZ);
