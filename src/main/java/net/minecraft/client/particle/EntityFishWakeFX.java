...
{
    protected EntityFishWakeFX(World world, double xCoordIn, double yCoordIn, double zCoordIn, double p_i45073_8_, double p_i45073_10_, double p_i45073_12_)
    {
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new EntityFishWakeFX(world, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
        }
    }
}
