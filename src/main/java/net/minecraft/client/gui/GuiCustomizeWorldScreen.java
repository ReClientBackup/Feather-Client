...
{
    private WorldCreateScreen field_175343_i;
    ...
    {
        this.field_175343_i = (WorldCreateScreen)p_i45521_1_;
    ...
    public void initGui()
    {
        ...
        this.field_175351_y.setVisible(false);
        this.buttonList.add(this.field_175351_y);

        if (this.field_175339_B != 0)
        {
            this.field_175352_x.setVisible(true);
            this.field_175351_y.setVisible(true);
        }
    ...
    private void func_175325_f()
    {
        ...
        this.field_175349_r = new GuiPageButtonList(getMc(), this.width, this.height, 32, this.height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][] {aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry1, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3});
    ...
    private void func_181031_a(boolean p_181031_1_)
    {
        ...
        this.field_175346_u.setEnabled(p_181031_1_);
    }
        ...
        if (button.isEnabled())
        {
            switch (button.getId())
            {
                case 300:
                    ...
                    changeScreen(this.field_175343_i);
                    break;
                ...
                case 305:
                    changeScreen(new GuiScreenCustomizePresets(this));
                    break;
    ...
    {
        this.field_175352_x.setVisible(p_175329_1_);
        this.field_175351_y.setVisible(p_175329_1_);
        this.field_175347_t.setEnabled(!p_175329_1_);
        this.field_175348_s.setEnabled(!p_175329_1_);
        this.field_175345_v.setEnabled(!p_175329_1_);
        this.field_175344_w.setEnabled(!p_175329_1_);
        this.field_175346_u.setEnabled(this.field_175338_A && !p_175329_1_);
        this.field_175350_z.setEnabled(!p_175329_1_);
        this.field_175349_r.func_181155_a(!p_175329_1_);
    }

    private void func_175328_i()
    {
        this.field_175345_v.setEnabled(this.field_175349_r.func_178059_e() != 0);
        this.field_175344_w.setEnabled(this.field_175349_r.func_178059_e() != this.field_175349_r.func_178057_f() - 1);
        ...
        this.field_175347_t.setEnabled(this.field_175349_r.func_178059_e() != this.field_175349_r.func_178057_f() - 1);
    }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int mouseButton)
    {
        ...
        {
            this.field_175349_r.mouseReleased(mouseX, mouseY, mouseButton);
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        getFr().drawCenteredString(this.field_175341_a, this.width / 2, 2, 16777215);
        getFr().drawCenteredString(this.field_175333_f, this.width / 2, 12, 16777215);
        getFr().drawCenteredString(this.field_175335_g, this.width / 2, 22, 16777215);
        ...
        if (this.field_175339_B != 0)
        {
            ...
            worldrenderer.pos(this.width / 2 - 90, 185.0D, 0.0D).tex(0.0D, 2.65625D).color(64, 64, 64, 64).func_181675_d();
            worldrenderer.pos(this.width / 2 + 90, 185.0D, 0.0D).tex(5.625D, 2.65625D).color(64, 64, 64, 64).func_181675_d();
            worldrenderer.pos(this.width / 2 + 90, 100.0D, 0.0D).tex(5.625D, 0.0D).color(64, 64, 64, 64).func_181675_d();
            worldrenderer.pos(this.width / 2 - 90, 100.0D, 0.0D).tex(0.0D, 0.0D).color(64, 64, 64, 64).func_181675_d();
            tessellator.draw();
            getFr().drawCenteredString(I18n.format("createWorld.customize.custom.confirmTitle"), this.width / 2, 105, 16777215);
            getFr().drawCenteredString(I18n.format("createWorld.customize.custom.confirm1"), this.width / 2, 125, 16777215);
            getFr().drawCenteredString(I18n.format("createWorld.customize.custom.confirm2"), this.width / 2, 135, 16777215);
            this.field_175352_x.drawButton(mouseX, mouseY);
            this.field_175351_y.drawButton(mouseX, mouseY);
        }
    }
}
