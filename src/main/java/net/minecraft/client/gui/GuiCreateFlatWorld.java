...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_146389_t.setVisible(false);
        this.field_146388_u.setVisible(false);
    ...
    public void func_146375_g()
    {
        ...
        this.field_146386_v.setEnabled(flag);
        this.field_146388_u.setEnabled(flag);
        this.field_146388_u.setEnabled(false);
        this.field_146389_t.setEnabled(false);
    }
    ...
    class Details extends GuiSlot
    {
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_)
        {
            ...
            worldrenderer.pos(p_148224_1_ + 0, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel).tex((float)(p_148224_3_ + 0) * 0.0078125F, (float)(p_148224_4_ + 18) * 0.0078125F).func_181675_d();
            worldrenderer.pos(p_148224_1_ + 18, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel).tex((float)(p_148224_3_ + 18) * 0.0078125F, (float)(p_148224_4_ + 18) * 0.0078125F).func_181675_d();
            worldrenderer.pos(p_148224_1_ + 18, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel).tex((float)(p_148224_3_ + 18) * 0.0078125F, (float)(p_148224_4_ + 0) * 0.0078125F).func_181675_d();
            worldrenderer.pos(p_148224_1_ + 0, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel).tex((float)(p_148224_3_ + 0) * 0.0078125F, (float)(p_148224_4_ + 0) * 0.0078125F).func_181675_d();
            tessellator.draw();
        }
