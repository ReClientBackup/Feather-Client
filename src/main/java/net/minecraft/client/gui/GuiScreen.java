...
public abstract class GuiScreen extends Gui implements YesNoCallback
{
                ...
                if (clickevent.getAction() == ClickEvent.Action.OPEN_URL)
                {
                    ...
                    try
                    {
                        ...
                        if (this.mc.gameSettings.chatLinksPrompt)
                        {
                            ...
                            this.mc.displayGuiScreen(new ConfirmOpenLinkScreen(this, clickevent.getValue(), 31102009, false));
                        }
                        else
                        {
    ...
    public void drawBackground(int tint)
    {
        ...
        worldrenderer.pos(0.0D, this.height, 0.0D).tex(0.0D, (float)this.height / 32.0F + (float)tint).color(64, 64, 64, 255).func_181675_d();
        worldrenderer.pos(this.width, this.height, 0.0D).tex((float)this.width / 32.0F, (float)this.height / 32.0F + (float)tint).color(64, 64, 64, 255).func_181675_d();
        worldrenderer.pos(this.width, 0.0D, 0.0D).tex((float)this.width / 32.0F, tint).color(64, 64, 64, 255).func_181675_d();
