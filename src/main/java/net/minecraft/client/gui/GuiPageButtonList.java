...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    private void func_178066_a(GUI p_178066_1_, boolean p_178066_2_)
    {
        ...
        {
            ((GuiButton)p_178066_1_).setVisible(p_178066_2_);
        }
    ...
    public void func_181155_a(boolean p_181155_1_)
    {
        for (GuiPageButtonList.GuiEntry guipagebuttonlist$guientry : this.field_178074_u)
        {
            ...
            {
                ((GuiButton)guipagebuttonlist$guientry.field_178029_b).setEnabled(p_181155_1_);
            }

            if (guipagebuttonlist$guientry.field_178030_c instanceof GuiButton)
            {
                ((GuiButton)guipagebuttonlist$guientry.field_178030_c).setEnabled(p_181155_1_);
            }
        }
    }
    ...
    private GuiSlider func_178067_a(int p_178067_1_, int p_178067_2_, GuiPageButtonList.GuiSlideEntry p_178067_3_)
    {
        ...
        guislider.setVisible(p_178067_3_.func_178934_d());
        return guislider;
    }
    ...
    private GuiListButton func_178065_a(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_)
    {
        ...
        guilistbutton.setVisible(p_178065_3_.func_178934_d());
    ...
    private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_)
    {
        ...
        if (p_178063_4_)
        {
            guilabel = new GuiLabel(p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.width - p_178063_1_ * 2, 20, -1);
        }
        else
        {
            guilabel = new GuiLabel(p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
        }
    ...
    public static class GuiEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        {
            p_178024_1_.setY(p_178024_2_);

            if (!p_178024_5_)
            {
                p_178024_1_.drawButton(p_178024_3_, p_178024_4_);
            }
        }
        ...
        {
            this.func_178017_a(this.field_178029_b, y, 0, 0, true);
            this.func_178017_a(this.field_178030_c, y, 0, 0, true);
        }

        public boolean mousePressed(int slotIndex, int x, int y, int mouseEvent, int relativeX, int relativeY)
        {
            boolean flag = this.func_178026_a(this.field_178029_b, x, y, mouseEvent);
            boolean flag1 = this.func_178026_a(this.field_178030_c, x, y, mouseEvent);
            return flag || flag1;
        }
