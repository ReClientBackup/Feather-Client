...
public class GuiBeacon extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        this.beaconConfirmButton.setEnabled(false);
    }
    ...
    public void updateScreen()
    {
        ...
        if (this.buttonsNotDrawn && i >= 0)
        {
            ...
            for (int l = 0; l <= 2; ++l)
            {
                ...
                for (int k1 = 0; k1 < i1; ++k1)
                {
                    ...
                    if (l >= i)
                    {
                        guibeacon$powerbutton.setEnabled(false);
                    }
                    else if (l1 == j)
                    {
            ...
            for (int l2 = 0; l2 < j2 - 1; ++l2)
            {
                ...
                if (i2 >= i)
                {
                    guibeacon$powerbutton2.setEnabled(false);
                }
                else if (i3 == k)
                {
            ...
            if (j > 0)
            {
                ...
                if (i2 >= i)
                {
                    guibeacon$powerbutton1.setEnabled(false);
                }
                else if (j == k)
                {
        ...
        this.beaconConfirmButton.setEnabled(this.tileBeacon.getStackInSlot(0) != null && j > 0);
    }
