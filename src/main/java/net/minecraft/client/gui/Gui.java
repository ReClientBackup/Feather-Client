...
public class Gui
{
    ...
    public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height)
    {
        ...
        worldrenderer.pos(x + 0, y + height, this.zLevel).tex((float)(textureX + 0) * f, (float)(textureY + height) * f1).func_181675_d();
        worldrenderer.pos(x + width, y + height, this.zLevel).tex((float)(textureX + width) * f, (float)(textureY + height) * f1).func_181675_d();
        worldrenderer.pos(x + width, y + 0, this.zLevel).tex((float)(textureX + width) * f, (float)(textureY + 0) * f1).func_181675_d();
        worldrenderer.pos(x + 0, y + 0, this.zLevel).tex((float)(textureX + 0) * f, (float)(textureY + 0) * f1).func_181675_d();
        tessellator.draw();
    }
    ...
    public void drawTexturedModalRect(float xCoord, float yCoord, int minU, int minV, int maxU, int maxV)
    {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldrenderer.pos(xCoord + 0.0F, yCoord + (float)maxV, this.zLevel).tex((float)(minU + 0) * f, (float)(minV + maxV) * f1).func_181675_d();
        worldrenderer.pos(xCoord + (float)maxU, yCoord + (float)maxV, this.zLevel).tex((float)(minU + maxU) * f, (float)(minV + maxV) * f1).func_181675_d();
        worldrenderer.pos(xCoord + (float)maxU, yCoord + 0.0F, this.zLevel).tex((float)(minU + maxU) * f, (float)(minV + 0) * f1).func_181675_d();
        worldrenderer.pos(xCoord + 0.0F, yCoord + 0.0F, this.zLevel).tex((float)(minU + 0) * f, (float)(minV + 0) * f1).func_181675_d();
        tessellator.draw();
    }
    ...
    public void drawTexturedModalRect(int xCoord, int yCoord, TextureAtlasSprite textureSprite, int widthIn, int heightIn)
    {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldrenderer.pos(xCoord + 0, yCoord + heightIn, this.zLevel).tex(textureSprite.getMinU(), textureSprite.getMaxV()).func_181675_d();
        ...
        worldrenderer.pos(xCoord + widthIn, yCoord + 0, this.zLevel).tex(textureSprite.getMaxU(), textureSprite.getMinV()).func_181675_d();
        worldrenderer.pos(xCoord + 0, yCoord + 0, this.zLevel).tex(textureSprite.getMinU(), textureSprite.getMinV()).func_181675_d();
        tessellator.draw();
    }
