...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    {
        this.field_175316_h.setEnabled(this.func_175305_g());
    }
    ...
    class ListPreset extends GuiSlot
    {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_)
        {
            ...
            worldrenderer.pos(i + 0, p_178051_2_ + 32, 0.0D).tex(0.0D, 1.0D).func_181675_d();
            worldrenderer.pos(i + 32, p_178051_2_ + 32, 0.0D).tex(1.0D, 1.0D).func_181675_d();
            worldrenderer.pos(i + 32, p_178051_2_ + 0, 0.0D).tex(1.0D, 0.0D).func_181675_d();
            worldrenderer.pos(i + 0, p_178051_2_ + 0, 0.0D).tex(0.0D, 0.0D).func_181675_d();
            tessellator.draw();
        }
