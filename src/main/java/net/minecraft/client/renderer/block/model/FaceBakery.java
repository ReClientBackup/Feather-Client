...
public class FaceBakery {
    ...
    private static final float field_178418_a = 1.0F / (float)Math.cos(0.39269909262657166D) - 1.0F, field_178417_b = 1.0F / (float)Math.cos((Math.PI / 4D)) - 1.0F;
    ...
    private void func_178408_a(int[] p_178408_1_, EnumFacing p_178408_2_) {
        ...
        for (int j1 = 0; j1 < 4; ++j1) {
            int k1 = i * j1;
            EnumFaceDirection.VertexInformation information = enumfacedirection.func_179025_a(j1);
            float f8 = afloat[information.field_179184_a];
            float f3 = afloat[information.field_179182_b];
            float f4 = afloat[information.field_179183_c];
