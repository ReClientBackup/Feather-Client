...
public class OpenGlHelper {
	...
	public static boolean nvidia, field_181063_b;
	public static int GL_FRAMEBUFFER, GL_RENDERBUFFER, GL_COLOR_ATTACHMENT0, GL_DEPTH_ATTACHMENT, GL_FRAMEBUFFER_COMPLETE, GL_FB_INCOMPLETE_ATTACHMENT, GL_FB_INCOMPLETE_MISS_ATTACH, GL_FB_INCOMPLETE_DRAW_BUFFER, GL_FB_INCOMPLETE_READ_BUFFER;
	private static int framebufferType;
	public static boolean framebufferSupported;
	private static boolean arbShaders, arbMultitexture;
	public static int GL_LINK_STATUS, GL_COMPILE_STATUS, GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, defaultTexUnit, lightmapTexUnit, GL_TEXTURE2;
	public static int GL_COMBINE, GL_INTERPOLATE, GL_PRIMARY_COLOR, GL_CONSTANT, GL_PREVIOUS, GL_COMBINE_RGB, GL_SOURCE0_RGB, GL_SOURCE1_RGB, GL_SOURCE2_RGB, GL_OPERAND0_RGB, GL_OPERAND1_RGB, GL_OPERAND2_RGB, GL_COMBINE_ALPHA, GL_SOURCE0_ALPHA, GL_SOURCE1_ALPHA, GL_SOURCE2_ALPHA, GL_OPERAND0_ALPHA, GL_OPERAND1_ALPHA, GL_OPERAND2_ALPHA;
	private static boolean openGL14;
	public static boolean extBlendFuncSeparate, openGL21, shadersSupported;
	private static String logText = "", field_183030_aa;
	public static boolean vboSupported, field_181062_Q;
	private static boolean arbVbo;
	public static int GL_ARRAY_BUFFER, GL_STATIC_DRAW;
	public static float lastBrightnessX = 0.0F, lastBrightnessY = 0.0F;
	public static boolean openGL31, vboRegions;
	public static int GL_COPY_READ_BUFFER, GL_COPY_WRITE_BUFFER;
