...
public class ActiveRenderInfo {
	...
	private static final FloatBuffer MODELVIEW = GLAllocation.createDirectFloatBuffer(16), PROJECTION = GLAllocation.createDirectFloatBuffer(16), OBJECTCOORDS = GLAllocation.createDirectFloatBuffer(3);
	private static Vec3 position = new Vec3(0.0D, 0.0D, 0.0D);
	private static float rotationX, rotationXZ, rotationZ, rotationYZ, rotationXY;
