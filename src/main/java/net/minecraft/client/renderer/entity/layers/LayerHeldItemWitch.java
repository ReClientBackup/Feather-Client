...
public class LayerHeldItemWitch implements LayerRenderer<EntityWitch> {
	...
	public LayerHeldItemWitch(RenderWitch witchRenderer) {
		this.witchRenderer = witchRenderer;
	}

	public void doRenderLayer(EntityWitch entityLivingBase, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
