...
public class BlockFenceGate extends BlockDirectional
{
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos)
    {
        ...
        if (enumfacing$axis == EnumFacing.Axis.Z && (world.getBlockState(pos.west()).getBlock() == Blocks.cobblestone_wall || world.getBlockState(pos.east()).getBlock() == Blocks.cobblestone_wall) || enumfacing$axis == EnumFacing.Axis.X && (world.getBlockState(pos.north()).getBlock() == Blocks.cobblestone_wall || world.getBlockState(pos.south()).getBlock() == Blocks.cobblestone_wall))
        {
    ...
    {
        EnumFacing.Axis enumfacing$axis = world.getBlockState(pos).getValue(FACING).getAxis();
