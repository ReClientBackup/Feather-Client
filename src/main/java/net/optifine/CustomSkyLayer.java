...
public class CustomSkyLayer
{
    ...
    private void renderSide(Tessellator tess, int side)
    {
        ...
        worldrenderer.pos(-100.0D, -100.0D, -100.0D).tex(d0, d1).func_181675_d();
        worldrenderer.pos(-100.0D, -100.0D, 100.0D).tex(d0, d1 + 0.5D).func_181675_d();
        worldrenderer.pos(100.0D, -100.0D, 100.0D).tex(d0 + 0.3333333333333333D, d1 + 0.5D).func_181675_d();
        worldrenderer.pos(100.0D, -100.0D, -100.0D).tex(d0 + 0.3333333333333333D, d1).func_181675_d();
        tess.draw();
    }
