...
public class GuiShaderOptions extends GuiScreenOF {
      ...
      if(ashaderoption != null) {
         ...
         for(int i2 = 0; i2 < ashaderoption.length; ++i2) {
            ...
            if(shaderoption != null && shaderoption.isVisible()) {
               ...
               guibuttonshaderoption.setEnabled(shaderoption.isEnabled());
               addButton(guibuttonshaderoption);
            }
         }
      }

      addButton(new GuiButton(201, this.width / 2 - i1 - 20, this.height / 6 + 168 + 11, i1, j1, I18n.format("controls.reset", new Object[0])));
      addButton(new GuiButton(200, this.width / 2 + 20, this.height / 6 + 168 + 11, i1, j1, I18n.format("gui.done", new Object[0])));
   }
   ...
   protected void actionPerformed(GuiButton guibutton) {
      if(guibutton.isEnabled()) {
         if(guibutton.getId() < 200 && guibutton instanceof GuiButtonShaderOption) {
