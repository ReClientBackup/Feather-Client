...
public class Lagometer {
   ...
   private static long renderTime(int frameNum, long time, int r, int g, int b, float baseHeight, WorldRenderer worldRenderer) {
      ...
      if(i < 3L) {
         ...
         worldRenderer.pos((float)frameNum + 0.5F, baseHeight - (float)i + 0.5F, 0.0D).color(r, g, b, 255).endVertex();
         worldRenderer.pos((float)frameNum + 0.5F, baseHeight + 0.5F, 0.0D).color(r, g, b, 255).endVertex();
         return i;
      }
   }
   ...
   private static long renderTimeDivider(int frameStart, int frameEnd, long time, int r, int g, int b, float baseHeight, WorldRenderer worldRenderer) {
      ...
      if(i < 3L) {
         ...
         worldRenderer.pos((float)frameStart + 0.5F, baseHeight - (float)i + 0.5F, 0.0D).color(r, g, b, 255).endVertex();
         worldRenderer.pos((float)frameEnd + 0.5F, baseHeight - (float)i + 0.5F, 0.0D).color(r, g, b, 255).endVertex();
         return i;
      }
   }
