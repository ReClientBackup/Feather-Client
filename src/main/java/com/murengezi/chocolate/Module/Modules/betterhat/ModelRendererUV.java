...
public class ModelRendererUV extends ModelRenderer
{
     ...
     */
    public void addBox(float originX, float originY, float originZ, int width, int height, int depth, float scaleFactor)
    {
        this.cubeList.add(new ModelBox(this, this.textureOffsetX, this.textureOffsetY, originX, originY, originZ, width, height, depth, scaleFactor));
    }
