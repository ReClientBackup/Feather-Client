...
public class CrashReportCategory {
    ...
    public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement s1, StackTraceElement s2) {
        if (this.stackTrace.length != 0 && s1 != null) {
            StackTraceElement traceElement = this.stackTrace[0];

            if (traceElement.isNativeMethod() == s1.isNativeMethod() && traceElement.getClassName().equals(s1.getClassName()) && Objects.equals(traceElement.getFileName(), s1.getFileName()) && traceElement.getMethodName().equals(s1.getMethodName())) {
