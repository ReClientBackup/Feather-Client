package com.murengezi.minecraft.client.shader;
...
public class Framebuffer {
    ...
    public int framebufferTextureWidth, framebufferTextureHeight, framebufferWidth, framebufferHeight, framebufferObject, framebufferTexture, depthBuffer, framebufferFilter;
    ...
    public void setFramebufferFilter(int framebufferFilter) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            GlStateManager.bindTexture(this.framebufferTexture);
            GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, (float)framebufferFilter);
            GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, (float)framebufferFilter);
