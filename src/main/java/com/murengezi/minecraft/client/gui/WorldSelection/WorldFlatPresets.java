 ...
 * Created on 2021-01-25 at 12:06
 */
public class WorldFlatPresets extends Screen {

	private static final List<WorldFlatPresets.LayerItem> FLAT_WORLD_PRESETS = Lists.<WorldFlatPresets.LayerItem>newArrayList();

	/** The parent GUI */
	private final WorldCreateFlatScreen parentScreen;
	private String presetsTitle;
	private String presetsShare;
	private String field_146436_r;
	private WorldFlatPresets.ListSlot field_146435_s;
	private GuiButton field_146434_t;
	private GuiTextField field_146433_u;

	public WorldFlatPresets(WorldCreateFlatScreen parentScreen) {
	...
	public void initGui() {
		...
		this.field_146435_s = new WorldFlatPresets.ListSlot();
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		this.drawDefaultBackground(mouseX, mouseY, 30);
	...
	public void func_146426_g() {
		...
		this.field_146434_t.setEnabled(flag);
	}
	...
	private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List<String> p_175354_4_, FlatLayerInfo... p_175354_5_) {
		...
		FLAT_WORLD_PRESETS.add(new WorldFlatPresets.LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, flatgeneratorinfo.toString()));
	}
	...
	class ListSlot extends GuiSlot {
		...
		public ListSlot() {
			super(WorldFlatPresets.this.mc, WorldFlatPresets.this.width, WorldFlatPresets.this.height, 80, WorldFlatPresets.this.height - 37, 24);
		}
		...
		private void func_178054_a(int p_178054_1_, int p_178054_2_, Item p_178054_3_, int p_178054_4_) {
			...
			WorldFlatPresets.this.itemRender.renderItemIntoGUI(new ItemStack(p_178054_3_, 1, p_178054_4_), p_178054_1_ + 2, p_178054_2_ + 2);
		...
		private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
			...
			worldrenderer.pos(p_148171_1_, p_148171_2_ + 18, WorldFlatPresets.this.zLevel).tex((float)(p_148171_3_) * 0.0078125F, (float)(p_148171_4_ + 18) * 0.0078125F).func_181675_d();
			worldrenderer.pos(p_148171_1_ + 18, p_148171_2_ + 18, WorldFlatPresets.this.zLevel).tex((float)(p_148171_3_ + 18) * 0.0078125F, (float)(p_148171_4_ + 18) * 0.0078125F).func_181675_d();
			worldrenderer.pos(p_148171_1_ + 18, p_148171_2_, WorldFlatPresets.this.zLevel).tex((float)(p_148171_3_ + 18) * 0.0078125F, (float)(p_148171_4_) * 0.0078125F).func_181675_d();
			worldrenderer.pos(p_148171_1_, p_148171_2_, WorldFlatPresets.this.zLevel).tex((float)(p_148171_3_) * 0.0078125F, (float)(p_148171_4_) * 0.0078125F).func_181675_d();
			tessellator.draw();
		}

		@Override
		protected int getSize() {
			return WorldFlatPresets.FLAT_WORLD_PRESETS.size();
		}

		@Override
		protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
			this.field_148175_k = slotIndex;
			WorldFlatPresets.this.func_146426_g();
			WorldFlatPresets.this.field_146433_u.setText(WorldFlatPresets.FLAT_WORLD_PRESETS.get(WorldFlatPresets.this.field_146435_s.field_148175_k).field_148233_c);
		}
		...
		protected void drawSlot(int entryID, int x, int y, int p_180791_4_, int mouseXIn, int mouseYIn) {
			WorldFlatPresets.LayerItem WorldFlatPresets$layeritem = WorldFlatPresets.FLAT_WORLD_PRESETS.get(entryID);
			this.func_178054_a(x, y, WorldFlatPresets$layeritem.field_148234_a, WorldFlatPresets$layeritem.field_179037_b);
			WorldFlatPresets.this.fontRendererObj.drawString(WorldFlatPresets$layeritem.field_148232_b, x + 18 + 5, y + 6, 16777215);
		}
	}
