package com.murengezi.minecraft.client.settings;
...
public class GameSettings extends MinecraftUtils {
	...
	public boolean viewBobbing = true, anaglyph, fboEnable = true;
	public int limitFramerate = 120, clouds = 2;
	public boolean fancyGraphics = true;
	public int ambientOcclusion = 2;
	public List<String> resourcePacks = Lists.newArrayList(), field_183018_l = Lists.newArrayList();
	public EntityPlayer.EnumChatVisibility chatVisibility = EntityPlayer.EnumChatVisibility.FULL;
	public boolean chatColours = true, chatLinks = true, chatLinksPrompt = true;
	public float chatOpacity = 1.0F;
	public boolean snooperEnabled = true, fullScreen, enableVsync = true, useVbo = false, allowBlockAlternatives = true, reducedDebugInfo = false, hideServerAddress, advancedItemTooltips, pauseOnLostFocus = true;
	private final Set<EnumPlayerModelParts> setModelParts = Sets.newHashSet(EnumPlayerModelParts.values());
	public int overrideWidth, overrideHeight;
	public boolean heldItemTooltips = true;
	public float chatScale = 1.0F, chatWidth = 1.0F, chatHeightUnfocused = 0.44366196F, chatHeightFocused = 1.0F;
	public boolean showInventoryAchievementHint = true;
	public int mipmapLevels = 4;
	private final Map<SoundCategory, Float> mapSoundLevels = Maps.newEnumMap(SoundCategory.class);
	public boolean field_181150_U = true, field_181151_V = true, field_183509_X = true;

	/**
	 * Perspective mod
	 */
	public KeyBinding keyPerspective = new KeyBinding("Toggle Perspective", Keyboard.KEY_LMENU, "Perspective Mod"), keyBindForward = new KeyBinding("key.forward", 17, "key.categories.movement"), keyBindLeft = new KeyBinding("key.left", 30, "key.categories.movement"), keyBindBack = new KeyBinding("key.back", 31, "key.categories.movement"), keyBindRight = new KeyBinding("key.right", 32, "key.categories.movement"), keyBindJump = new KeyBinding("key.jump", 57, "key.categories.movement"), keyBindSneak = new KeyBinding("key.sneak", 42, "key.categories.movement"), keyBindSprint = new KeyBinding("key.sprint", 29, "key.categories.movement"), keyBindInventory = new KeyBinding("key.inventory", 18, "key.categories.inventory"), keyBindUseItem = new KeyBinding("key.use", -99, "key.categories.gameplay"), keyBindDrop = new KeyBinding("key.drop", 16, "key.categories.gameplay"), keyBindAttack = new KeyBinding("key.attack", -100, "key.categories.gameplay"), keyBindPickBlock = new KeyBinding("key.pickItem", -98, "key.categories.gameplay"), keyBindChat = new KeyBinding("key.chat", 20, "key.categories.multiplayer"), keyBindPlayerList = new KeyBinding("key.playerlist", 15, "key.categories.multiplayer"), keyBindCommand = new KeyBinding("key.command", 53, "key.categories.multiplayer"), keyBindScreenshot = new KeyBinding("key.screenshot", 60, "key.categories.misc"), keyBindTogglePerspective = new KeyBinding("key.togglePerspective", 63, "key.categories.misc"), keyBindSmoothCamera = new KeyBinding("key.smoothCamera", 0, "key.categories.misc"), keyBindFullscreen = new KeyBinding("key.fullscreen", 87, "key.categories.misc"), keyBindSpectatorOutlines = new KeyBinding("key.spectatorOutlines", 0, "key.categories.misc");
	public KeyBinding[] keyBindsHotbar = new KeyBinding[]{new KeyBinding("key.hotbar.1", 2, "key.categories.inventory"), new KeyBinding("key.hotbar.2", 3, "key.categories.inventory"), new KeyBinding("key.hotbar.3", 4, "key.categories.inventory"), new KeyBinding("key.hotbar.4", 5, "key.categories.inventory"), new KeyBinding("key.hotbar.5", 6, "key.categories.inventory"), new KeyBinding("key.hotbar.6", 7, "key.categories.inventory"), new KeyBinding("key.hotbar.7", 8, "key.categories.inventory"), new KeyBinding("key.hotbar.8", 9, "key.categories.inventory"), new KeyBinding("key.hotbar.9", 10, "key.categories.inventory")}, keyBindings;
	private File optionsFile;
	public EnumDifficulty difficulty;
	public boolean hideGUI;
	public int thirdPersonView;
	public boolean showDebugInfo, showDebugProfilerChart, field_181657_aC;
	public String lastServer;
	public boolean smoothCamera, debugCamEnable;
	public float fovSetting, gammaSetting, saturation;
	public int guiScale, particleSetting;
	public String language;
	public boolean forceUnicodeFont;
	public int ofFogType = 1;
	public float ofFogStart = 0.8F;
	public int ofMipmapType = 0;
	public boolean ofOcclusionFancy = false, ofSmoothFps = false, ofSmoothWorld = Config.isSingleProcessor(), ofLazyChunkLoading = Config.isSingleProcessor(), ofRenderRegions = false, ofSmartAnimations = false;
	public float ofAoLevel = 1.0F;
	public int ofAaLevel = 0, ofAfLevel = 1, ofClouds = 0;
	public float ofCloudsHeight = 0.0F;
	public int ofTrees = 0, ofRain = 0, ofDroppedItems = 0, ofBetterGrass = 3, ofAutoSaveTicks = 4000;
	public boolean ofLagometer = false, ofProfiler = false, ofShowFps = false, ofWeather = true, ofSky = true, ofStars = true, ofSunMoon = true;
	public int ofVignette = 0, ofChunkUpdates = 1;
	public boolean ofChunkUpdatesDynamic = false;
	public int ofTime = 0;
	public boolean ofClearWater = false, ofBetterSnow = false;
	public String ofFullscreenMode = "Default";
	public boolean ofSwampColors = true, ofRandomEntities = true, ofSmoothBiomes = true, ofCustomFonts = true, ofCustomColors = true, ofCustomSky = true, ofShowCapes = true;
	public int ofConnectedTextures = 2;
	public boolean ofCustomItems = true, ofNaturalTextures = false, ofEmissiveTextures = true, ofFastMath = false, ofFastRender = false;
	public int ofTranslucentBlocks = 0;
	public boolean ofDynamicFov = true, ofAlternateBlocks = true;
	public int ofDynamicLights = 3;
	public boolean ofCustomEntityModels = true, ofCustomGuis = true, ofShowGlErrors = true;
	public int ofScreenshotSize = 1, ofAnimatedWater = 0, ofAnimatedLava = 0;
	public boolean ofAnimatedFire = true, ofAnimatedPortal = true, ofAnimatedRedstone = true, ofAnimatedExplosion = true, ofAnimatedFlame = true, ofAnimatedSmoke = true, ofVoidParticles = true, ofWaterParticles = true, ofRainSplash = true, ofPortalParticles = true, ofPotionParticles = true, ofFireworkParticles = true, ofDrippingWaterLava = true, ofAnimatedTerrain = true, ofAnimatedTextures = true;
	public static final int DEFAULT = 0, FAST = 1, OFF = 3;
	private static final int[] OF_TREES_VALUES = new int[]{0, 1, 4, 2}, OF_DYNAMIC_LIGHTS = new int[]{3, 1, 2};
