...
public class KeyBinding implements Comparable<KeyBinding> {
	...
	public int compareTo(KeyBinding binding) {
		int i = I18n.format(this.category).compareTo(I18n.format(binding.category));

		if (i == 0) {
			i = I18n.format(this.description).compareTo(I18n.format(binding.description));
		}
