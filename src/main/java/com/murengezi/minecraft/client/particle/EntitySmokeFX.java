...
public class EntitySmokeFX extends EntityFX {
    ...
    private EntitySmokeFX(World world, double xCoord, double yCoord, double zCoord, double p_i46347_8_, double p_i46347_10_, double p_i46347_12_) {
        this(world, xCoord, yCoord, zCoord, p_i46347_8_, p_i46347_10_, p_i46347_12_, 1.0F);
    }

    protected EntitySmokeFX(World world, double xCoord, double yCoord, double zCoord, double p_i46348_8_, double p_i46348_10_, double p_i46348_12_, float p_i46348_14_) {
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntitySmokeFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
        }
    }
