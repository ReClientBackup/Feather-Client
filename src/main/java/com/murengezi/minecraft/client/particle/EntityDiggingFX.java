...
public class EntityDiggingFX extends EntityFX {
    ...
    protected EntityDiggingFX(World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, IBlockState state) {
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return (new EntityDiggingFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed, Block.getStateById(p_178902_15_[0]))).func_174845_l();
        }
    }
