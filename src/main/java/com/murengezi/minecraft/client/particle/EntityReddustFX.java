...
public class EntityReddustFX extends EntityFX {
    ...
    protected EntityReddustFX(World world, double xCoord, double yCoord, double zCoord, float p_i46349_8_, float p_i46349_9_, float p_i46349_10_) {
        this(world, xCoord, yCoord, zCoord, 1.0F, p_i46349_8_, p_i46349_9_, p_i46349_10_);
    }

    protected EntityReddustFX(World world, double xCoord, double yCoord, double zCoord, float p_i46350_8_, float p_i46350_9_, float p_i46350_10_, float p_i46350_11_) {
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntityReddustFX(world, xCoord, yCoord, zCoord, (float)xSpeed, (float)ySpeed, (float)zSpeed);
        }
    }
