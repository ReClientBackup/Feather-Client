...
public class EntityHeartFX extends EntityFX {
    ...
    protected EntityHeartFX(World world, double p_i1211_2_, double p_i1211_4_, double p_i1211_6_)
    {
        this(world, p_i1211_2_, p_i1211_4_, p_i1211_6_, 2.0F);
    }

    protected EntityHeartFX(World world, double xCoord, double yCoord, double zCoord, float scale) {
    ...
    public static class AngryVillagerFactory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            EntityFX entityfx = new EntityHeartFX(world, xCoord, yCoord + 0.5D, zCoord);
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntityHeartFX(world, xCoord, yCoord, zCoord);
        }
    }
