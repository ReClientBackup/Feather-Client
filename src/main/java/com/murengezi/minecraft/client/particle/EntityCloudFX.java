...
public class EntityCloudFX extends EntityFX {
    ...
    protected EntityCloudFX(World world, double xCoord, double yCoord, double zCoord, double p_i1221_8_, double p_i1221_10_, double p_i1221_12_) {
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntityCloudFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
        }
    }
