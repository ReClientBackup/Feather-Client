...
public class EntitySpellParticleFX extends EntityFX {
    ...
    protected EntitySpellParticleFX(World world, double xCoord, double yCoord, double zCoord, double p_i1229_8_, double p_i1229_10_, double p_i1229_12_) {
        super(world, xCoord, yCoord, zCoord, 0.5D - RANDOM.nextDouble(), p_i1229_10_, 0.5D - RANDOM.nextDouble());
    ...
    public void setBaseSpellTextureIndex(int baseSpellTextureIndex) {
    ...
    public static class AmbientMobFactory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            EntityFX entityfx = new EntitySpellParticleFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
            entityfx.setAlphaF(0.15F);
            entityfx.setRBGColorF((float)xSpeed, (float)ySpeed, (float)zSpeed);
            return entityfx;
        }
    }
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntitySpellParticleFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
        }
    }
