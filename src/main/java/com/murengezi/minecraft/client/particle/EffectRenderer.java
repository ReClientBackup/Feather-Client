...
import com.murengezi.minecraft.client.renderer.ActiveRenderInfo;
...
public class EffectRenderer {
    ...
    private void tickParticle(final EntityFX entity) {
        try {
            entity.onUpdate();
            ...
            crashreportcategory.addCrashSectionCallable("Particle", entity::toString);
