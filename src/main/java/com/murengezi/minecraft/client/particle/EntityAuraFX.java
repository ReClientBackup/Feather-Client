...
public class EntityAuraFX extends EntityFX {
    ...
    protected EntityAuraFX(World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double speed) {
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntityAuraFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
        }
    }

    public static class HappyVillagerFactory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            EntityFX entityfx = new EntityAuraFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
