...
public class EntityFishWakeFX extends EntityFX {
    ...
    protected EntityFishWakeFX(World world, double xCoord, double yCoord, double zCoord, double p_i45073_8_, double p_i45073_10_, double p_i45073_12_) {
    ...
    public static class Factory implements IParticleFactory {
        public EntityFX getEntityFX(int particleID, World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, int... p_178902_15_) {
            return new EntityFishWakeFX(world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed);
        }
    }
