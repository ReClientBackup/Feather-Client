...
public class ModelHorse extends ModelBase {
    ...
    private void setBoxRotation(ModelRenderer modelRenderer, float rotationX, float rotationY, float rotationZ) {
        modelRenderer.rotateAngleX = rotationX;
        modelRenderer.rotateAngleY = rotationY;
        modelRenderer.rotateAngleZ = rotationZ;
    }
