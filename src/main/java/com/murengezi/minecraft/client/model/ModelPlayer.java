...
public class ModelPlayer extends ModelBiped {
    ...
    public ModelRenderer bipedLeftArmwear, bipedRightArmwear, bipedLeftLegwear, bipedRightLegwear, bipedBodyWear;
    private final ModelRenderer bipedCape, bipedDeadmau5Head;
