...
public class LanguageManager implements IResourceManagerReloadListener {
	...
	public LanguageManager(IMetadataSerializer theMetadataSerializer, String currentLanguage) {
		this.theMetadataSerializer = theMetadataSerializer;
		this.currentLanguage = currentLanguage;
		I18n.setLocale();
	}

	public void parseLanguageMetadata(List<IResourcePack> resourcePacks) {
