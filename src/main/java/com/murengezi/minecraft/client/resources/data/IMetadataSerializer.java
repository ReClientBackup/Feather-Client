...
public class IMetadataSerializer {
	...
	private final RegistrySimple metadataSectionSerializerRegistry = new RegistrySimple();
	...
	public <T extends IMetadataSection> T parseMetadataSection(String p_110503_1_, JsonObject p_110503_2_) {
		if (p_110503_1_ == null) {
			...
			IMetadataSerializer.Registration<?> registration = (Registration<?>) this.metadataSectionSerializerRegistry.getObject(p_110503_1_);
