...
public class DefaultPlayerSkin {
	...
	private static final ResourceLocation TEXTURE_STEVE = new ResourceLocation("textures/entity/steve.png"), TEXTURE_ALEX = new ResourceLocation("textures/entity/alex.png");
