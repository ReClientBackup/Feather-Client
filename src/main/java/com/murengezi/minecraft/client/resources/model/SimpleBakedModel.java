...
public class SimpleBakedModel implements IBakedModel {
	...
	protected final boolean ambientOcclusion, gui3d;
	protected final TextureAtlasSprite texture;
	protected final ItemCameraTransforms cameraTransforms;

	public SimpleBakedModel(List<BakedQuad> generalQuads, List<List<BakedQuad>> faceQuads, boolean ambientOcclusion, boolean gui3d, TextureAtlasSprite texture, ItemCameraTransforms cameraTransforms) {
	...
	public static class Builder {
		...
		public SimpleBakedModel.Builder addFaceQuad(EnumFacing facing, BakedQuad bakedQuad) {
		...
		public SimpleBakedModel.Builder setTexture(TextureAtlasSprite atlasSprite) {
			this.builderTexture = atlasSprite;
			return this;
		}
