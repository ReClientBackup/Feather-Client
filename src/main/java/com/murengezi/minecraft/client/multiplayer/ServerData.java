...
public class ServerData {
    ...
    public String serverName, serverIP, populationInfo, serverMOTD;
    ...
    public enum ServerResourceMode {
        ...
        ServerResourceMode(String mode) {
            this.motd = new ChatComponentTranslation("addServer.resourcePack." + mode);
        }
