...
import com.murengezi.minecraft.client.particle.EntityFirework;
...
public class WorldClient extends World
{
    ...
    public WorldClient(NetHandlerPlayClient netHandlerPlayClient, WorldSettings worldSettings, int dimension, EnumDifficulty enumDifficulty, Profiler profiler) {
        super(new SaveHandlerMP(), new WorldInfo(worldSettings, "MpServer"), WorldProvider.getProviderForDimension(dimension), profiler, true);
