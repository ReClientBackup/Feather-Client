...
import com.murengezi.minecraft.client.audio.ISound;
...
import com.murengezi.minecraft.client.renderer.chunk.*;
import com.murengezi.minecraft.client.renderer.culling.ClippingHelper;
import com.murengezi.minecraft.client.renderer.culling.ClippingHelperImpl;
import com.murengezi.minecraft.client.renderer.culling.Frustum;
...
import com.murengezi.minecraft.client.renderer.tileentity.RenderItemFrame;
...
import com.murengezi.minecraft.client.renderer.vertex.VertexBuffer;
...
import com.murengezi.minecraft.client.shader.ShaderLinkHelper;
...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
	...
	private static final ResourceLocation locationMoonPhasesPng = new ResourceLocation("textures/environment/moon_phases.png"), locationSunPng = new ResourceLocation("textures/environment/sun.png"), locationCloudsPng = new ResourceLocation("textures/environment/clouds.png"), locationEndSkyPng = new ResourceLocation("textures/environment/end_sky.png"), locationForcefieldPng = new ResourceLocation("textures/misc/forcefield.png");
	...
	private int starGLCallList = -1, glSkyList = -1, glSkyList2 = -1;
	...
	private double frustumUpdatePosX = Double.MIN_VALUE, frustumUpdatePosY = Double.MIN_VALUE, frustumUpdatePosZ = Double.MIN_VALUE;
	private int frustumUpdatePosChunkX = Integer.MIN_VALUE, frustumUpdatePosChunkY = Integer.MIN_VALUE, frustumUpdatePosChunkZ = Integer.MIN_VALUE;
	private double lastViewEntityX = Double.MIN_VALUE, lastViewEntityY = Double.MIN_VALUE, lastViewEntityZ = Double.MIN_VALUE, lastViewEntityPitch = Double.MIN_VALUE, lastViewEntityYaw = Double.MIN_VALUE;
	private final ChunkRenderDispatcher renderDispatcher = new ChunkRenderDispatcher();
	private ChunkRenderContainer renderContainer;
	private int renderDistanceChunks = -1, renderEntitiesStartupCounter = 2, countEntitiesTotal, countEntitiesRendered, countEntitiesHidden;
	...
	public Set chunksToResortTransparency = new LinkedHashSet(), chunksToUpdateForced = new LinkedHashSet();
	private final Deque visibilityDeque = new ArrayDeque();
	private List renderInfosEntities = new ArrayList(1024), renderInfosTileEntities = new ArrayList(1024);
	private final List renderInfosNormal = new ArrayList(1024), renderInfosEntitiesNormal = new ArrayList(1024), renderInfosTileEntitiesNormal = new ArrayList(1024), renderInfosShadow = new ArrayList(1024), renderInfosEntitiesShadow = new ArrayList(1024), renderInfosTileEntitiesShadow = new ArrayList(1024);
	private int renderDistance = 0, renderDistanceSq = 0;
	...
	public boolean renderOverlayDamaged = false, renderOverlayEyes = false;
	private boolean firstWorldLoad = false;
	private static int renderEntitiesCounter = 0;

	public RenderGlobal(Minecraft mc) {
	...
	public String getDebugInfoRenders() {
		...
		return String.format("C: %d/%d %sD: %d, %s", j, i, this.mc.renderChunkMany ? "(s) " : "", this.renderDistanceChunks, this.renderDispatcher.getDebugInfo());
	}
	...
	public void setupTerrain(Entity viewEntity, double partialTicks, ICamera camera, int frameCount, boolean playerSpectator) {
		...
		if (!flag && this.displayListEntitiesDirty && !Shaders.isShadowPass) {
			...
			boolean flag1 = this.mc.renderChunkMany;
	...
	public void renderBlockLayer(EnumWorldBlockLayer blockLayerIn, Entity entityIn) {
		...
		if (blockLayerIn == EnumWorldBlockLayer.TRANSLUCENT && !Shaders.isShadowPass) {
			...
			if (d0 * d0 + d1 * d1 + d2 * d2 > 1.0D) {
				...
				for (RenderGlobal.ContainerLocalRenderInformation information : this.renderInfos) {
