...
public enum EnumFaceDirection {
	...
	public static final class Constants {
		public static final int SOUTH_INDEX = EnumFacing.SOUTH.getIndex(), UP_INDEX = EnumFacing.UP.getIndex(), EAST_INDEX = EnumFacing.EAST.getIndex(), NORTH_INDEX = EnumFacing.NORTH.getIndex(), DOWN_INDEX = EnumFacing.DOWN.getIndex(), WEST_INDEX = EnumFacing.WEST.getIndex();
	}

	public static class VertexInformation {
		public final int field_179184_a, field_179182_b, field_179183_c;
