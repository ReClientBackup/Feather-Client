...
public class ItemTransformVec3f {
    ...
    public final Vector3f rotation, translation, scale;
    ...
    static class Deserializer implements JsonDeserializer<ItemTransformVec3f> {
        ...
        private static final Vector3f ROTATION_DEFAULT = new Vector3f(0.0F, 0.0F, 0.0F), TRANSLATION_DEFAULT = new Vector3f(0.0F, 0.0F, 0.0F), SCALE_DEFAULT = new Vector3f(1.0F, 1.0F, 1.0F);

        public ItemTransformVec3f deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context) throws JsonParseException {
