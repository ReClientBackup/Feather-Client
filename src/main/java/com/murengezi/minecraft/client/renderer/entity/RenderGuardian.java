...
public class RenderGuardian extends RenderLiving<EntityGuardian> {
	...
	private static final ResourceLocation GUARDIAN_TEXTURE = new ResourceLocation("textures/entity/guardian.png"), GUARDIAN_ELDER_TEXTURE = new ResourceLocation("textures/entity/guardian_elder.png"), GUARDIAN_BEAM_TEXTURE = new ResourceLocation("textures/entity/guardian_beam.png");
	int field_177115_a;
