...
import com.murengezi.minecraft.client.renderer.entity.layers.LayerCreeperCharge;
...
public class RenderCreeper extends RenderLiving<EntityCreeper> {
	...
	protected int getColorMultiplier(EntityCreeper entityCreeper, float lightBrightness, float partialTickTime) {
		float f = entityCreeper.getCreeperFlashIntensity(partialTickTime);
