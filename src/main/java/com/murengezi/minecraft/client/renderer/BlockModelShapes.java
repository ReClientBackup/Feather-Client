...
import com.murengezi.minecraft.client.renderer.block.statemap.BlockStateMapper;
import com.murengezi.minecraft.client.renderer.block.statemap.IStateMapper;
	...
	private void registerAllBlocks() {
		...
		this.registerBlockWithStateMapper(Blocks.quartz_block, new StateMapperBase() {
			protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
				BlockQuartz.EnumType enumType = state.getValue(BlockQuartz.VARIANT);
