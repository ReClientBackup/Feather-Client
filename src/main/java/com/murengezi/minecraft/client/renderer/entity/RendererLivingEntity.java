...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
	...
	public static float NAME_TAG_RANGE = 64.0F, NAME_TAG_RANGE_SNEAK = 32.0F;
	public EntityLivingBase renderEntity;
	public float renderLimbSwing, renderLimbSwingAmount, renderAgeInTicks, renderHeadYaw, renderHeadPitch, renderScaleFactor, renderPartialTicks;
	private boolean renderModelPushMatrix, renderLayersPushMatrix;
