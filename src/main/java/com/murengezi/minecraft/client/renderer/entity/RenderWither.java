...
import com.murengezi.minecraft.client.renderer.entity.layers.LayerWitherAura;
...
public class RenderWither extends RenderLiving<EntityWither> {
	...
	private static final ResourceLocation invulnerableWitherTextures = new ResourceLocation("textures/entity/wither/wither_invulnerable.png"), witherTextures = new ResourceLocation("textures/entity/wither/wither.png");
