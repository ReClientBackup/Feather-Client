...
public class ModelBlock {
    ...
    private final boolean gui3d, ambientOcclusion;
    ...
    public static ModelBlock deserialize(Reader reader) {
        return SERIALIZER.fromJson(reader, ModelBlock.class);
    }
    ...
    private ModelBlock(ResourceLocation parentLocation, List<BlockPart> elements, Map<String, String> textures, boolean ambientOcclusion, boolean gui3d, ItemCameraTransforms cameraTransforms) {
        this.name = "";
    ...
    static final class Bookkeep {
        ...
        private Bookkeep(ModelBlock model) {
            this.model = model;
        }
