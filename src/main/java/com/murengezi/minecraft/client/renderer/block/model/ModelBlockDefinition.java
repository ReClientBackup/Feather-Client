...
public class ModelBlockDefinition {
    ...
    public ModelBlockDefinition(Collection<ModelBlockDefinition.Variants> p_i46221_1_) {
        for (ModelBlockDefinition.Variants variants : p_i46221_1_) {
    ...
    public ModelBlockDefinition.Variants getVariants(String p_178330_1_) {
        ModelBlockDefinition.Variants variants = this.mapVariants.get(p_178330_1_);
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            return true;
        } else if (obj instanceof ModelBlockDefinition) {
    ...
    public static class Variant {
        ...
        public boolean equals(Object obj) {
            if (this == obj) {
                return true;
            } else if (!(obj instanceof ModelBlockDefinition.Variant)) {
                return false;
            } else {
                ModelBlockDefinition.Variant modelblockdefinition$variant = (ModelBlockDefinition.Variant)obj;
    ...
    public static class Variants {
        ...
        public Variants(String name, List<ModelBlockDefinition.Variant> listVariants) {
            this.name = name;
        ...
        public boolean equals(Object obj) {
            if (this == obj) {
                return true;
            } else if (!(obj instanceof ModelBlockDefinition.Variants)) {
                return false;
            } else {
                ModelBlockDefinition.Variants variants = (ModelBlockDefinition.Variants)obj;
