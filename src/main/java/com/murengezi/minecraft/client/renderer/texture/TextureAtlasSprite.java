...
import com.murengezi.minecraft.client.resources.data.AnimationFrame;
...
public class TextureAtlasSprite {
	...
	protected int frameCounter, tickCounter;
	private static String locationNameClock = "builtin/clock", locationNameCompass = "builtin/compass";
	private int indexInMap = -1;
	public float baseU, baseV;
	public int sheetWidth, sheetHeight, glSpriteTextureId = -1;
	public TextureAtlasSprite spriteSingle = null;
	public boolean isSpriteSingle = false;
	public int mipmapLevels = 0;
	public TextureAtlasSprite spriteNormal = null, spriteSpecular = null;
	public boolean isShadersSprite = false, isEmissive = false;
	...
	public ArrayList getFramesTextureData() {
        ArrayList list = new ArrayList(this.framesTextureData);
		return list;
	}
