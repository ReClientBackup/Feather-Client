...
import com.murengezi.minecraft.client.model.ModelQuadruped;
...
public class LayerMooshroomMushroom implements LayerRenderer<EntityMooshroom> {
	...
	public LayerMooshroomMushroom(RenderMooshroom mooshroomRenderer) {
	...
	public void doRenderLayer(EntityMooshroom entityLivingBase, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
		if (!entityLivingBase.isChild() && !entityLivingBase.isInvisible()) {
