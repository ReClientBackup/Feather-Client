...
public class ChunkRenderWorker implements Runnable {
    ...
    public ChunkRenderWorker(ChunkRenderDispatcher dispatcher, RegionRenderCacheBuilder builder) {
        this.chunkRenderDispatcher = dispatcher;
        this.regionRenderCacheBuilder = builder;
    }
