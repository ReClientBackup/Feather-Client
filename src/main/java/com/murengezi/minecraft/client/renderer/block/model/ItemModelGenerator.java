...
public class ItemModelGenerator {
    ...
    private List<BlockPart> func_178397_a(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_) {
        ...
        for (ItemModelGenerator.Span span : this.func_178393_a(p_178397_1_)) {
            float f2 = 0.0F;
            float f3 = 0.0F;
            float f4 = 0.0F;
            float f5 = 0.0F;
            ...
            ItemModelGenerator.SpanFacing facing = span.func_178383_a();
            ...
            f9 = f9 * f11;
            Map<EnumFacing, BlockPartFace> map = Maps.newHashMap();
            map.put(facing.getFacing(), new BlockPartFace(null, p_178397_3_, p_178397_2_, new BlockFaceUV(new float[] {f6, f8, f7, f9}, 0)));
    ...
    private void func_178395_a(List<ItemModelGenerator.Span> p_178395_1_, ItemModelGenerator.SpanFacing spanFacing, int p_178395_3_, int p_178395_4_) {
        ItemModelGenerator.Span span = null;

        for (ItemModelGenerator.Span span1 : p_178395_1_) {
            if (span1.func_178383_a() == spanFacing) {
                int i = spanFacing.func_178369_d() ? p_178395_4_ : p_178395_3_;

                if (span1.func_178381_d() == i) {
                    span = span1;
                    break;
                }
            }
        ...
        int j = spanFacing.func_178369_d() ? p_178395_4_ : p_178395_3_;
        int k = spanFacing.func_178369_d() ? p_178395_3_ : p_178395_4_;

        if (span == null) {
            p_178395_1_.add(new ItemModelGenerator.Span(spanFacing, k, j));
        } else {
            span.func_178382_a(k);
        }
    }
    ...
    static class Span {
        ...
        private int field_178387_b, field_178388_c;
        private final int field_178386_d;

        public Span(ItemModelGenerator.SpanFacing spanFacing, int p_i46216_2_, int p_i46216_3_) {
    ...
    enum SpanFacing {
        ...
        private final int field_178373_f, field_178374_g;
