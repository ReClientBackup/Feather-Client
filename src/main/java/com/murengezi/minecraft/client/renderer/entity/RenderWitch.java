...
import com.murengezi.minecraft.client.renderer.entity.layers.LayerHeldItemWitch;
...
public class RenderWitch extends RenderLiving<EntityWitch> {
	...
	protected ResourceLocation getEntityTexture(EntityWitch witch) {
	...
	protected void preRenderCallback(EntityWitch witch, float partialTickTime) {
		float f = 0.9375F;
