...
public class EnchantmentProtection extends Enchantment {
    ...
    private static final int[] baseEnchantability = new int[]{1, 10, 5, 5, 3}, levelEnchantability = new int[]{11, 8, 6, 8, 6}, thresholdEnchantability = new int[]{20, 12, 10, 12, 15};

    public final int protectionType;

    public EnchantmentProtection(int p_i45765_1_, ResourceLocation location, int p_i45765_3_, int p_i45765_4_) {
        super(p_i45765_1_, location, p_i45765_3_, EnumEnchantmentType.ARMOR);
