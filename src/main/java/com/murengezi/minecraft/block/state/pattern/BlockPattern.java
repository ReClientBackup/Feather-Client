...
public class BlockPattern {
    ...
    public BlockPattern.PatternHelper match(World world, BlockPos pos) {
        LoadingCache<BlockPos, BlockWorldState> loadingcache = func_181627_a(world, false);
    ...
    public static LoadingCache<BlockPos, BlockWorldState> func_181627_a(World world, boolean p_181627_1_) {
    ...
    static class CacheLoader extends com.google.common.cache.CacheLoader<BlockPos, BlockWorldState> {
        ...
        {
            return new BlockWorldState(this.world, pos, this.field_181626_b);
        }
    }
