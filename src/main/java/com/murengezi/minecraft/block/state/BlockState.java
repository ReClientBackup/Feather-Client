...
public class BlockState {
    ...
    public BlockState(Block block, IProperty... properties) {
        this.block = block;
        ...
        for (List<Comparable> list1 : Cartesian.cartesianProduct(this.getAllowedValues())) {
            ...
            BlockState.StateImplementation blockstate$stateimplementation = new BlockState.StateImplementation(block, ImmutableMap.copyOf(map1));
    ...
    static class StateImplementation extends BlockStateBase {
        ...
        private StateImplementation(Block block, ImmutableMap<IProperty, Comparable> propertiesIn) {
            this.block = block;
