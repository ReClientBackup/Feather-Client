...
public class BlockPrismarine extends Block {
    ...
    public static final int ROUGH_META = BlockPrismarine.EnumType.ROUGH.getMetadata(), BRICKS_META = BlockPrismarine.EnumType.BRICKS.getMetadata(), DARK_META = BlockPrismarine.EnumType.DARK.getMetadata();
    ...
    public enum EnumType implements IStringSerializable {
        ...
        static {
            for (BlockPrismarine.EnumType enumType : values()) {
