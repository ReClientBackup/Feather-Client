...
public class BlockPane extends Block {
    ...
    protected BlockPane(Material material, boolean canDrop) {
        super(material);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
        return state.withProperty(NORTH, this.canPaneConnectToBlock(world.getBlockState(pos.north()).getBlock())).withProperty(SOUTH, this.canPaneConnectToBlock(world.getBlockState(pos.south()).getBlock())).withProperty(WEST, this.canPaneConnectToBlock(world.getBlockState(pos.west()).getBlock())).withProperty(EAST, this.canPaneConnectToBlock(world.getBlockState(pos.east()).getBlock()));
    }
